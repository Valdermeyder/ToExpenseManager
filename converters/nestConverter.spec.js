...
test('should be able to convert PKO CSV files format', (done) => {
    ...
    const firstTransactionDescription = '"Opis transakcji"'
...
23-09-2020,19-09-2020,Płatności kartą,-16,PLN,,,${secondTransactionDescription},3964.82,`
    const expected = `08.10.2020,-19.17,Transport,Public transport,Credit Card,${firstTransactionDescription},,KASOWNIK 12,,,Nest
